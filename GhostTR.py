...
if input_user == '1': #OPSI 1
    ...
    stderr.writelines(f"""{Wh}
     ...
     .-.
   .'   `.          {Wh}--------------------------------
   :g g   :         {Wh}| {Gr}CREDO - TRACKER - IP ADDRESS {Wh}|
   : o    `.        {Wh}|       {Gr}@CODE BY CREDO.      {Wh}|
  :         ``.     {Wh}--------------------------------
 :             `.
:  :         .   `.
:   :          ` . `.
 `.. :            `. ``;
    ...
    stderr.writelines(f"""{Wh}
     ...
     .-.
   .'   `.          {Wh}----------------------------------
   :g g   :         {Wh}| {Gr}CREDO - TRACKER - PHONE NUMBER {Wh}|
   : o    `.        {Wh}|        {Gr}@CODE BY CREDO.       {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
:   :          ` . `.
 `.. :            `. ``;
    ...
    print(f"\n  {Wh}[{Ye}!{Wh}] {Ye}THANK'S FOR USING TOOL {Ye}CREDO-TRACK !")
else:
